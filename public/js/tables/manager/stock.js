        ...
        row.innerHTML = `
          ...
          <td>
            <div class="table-actions">
              <a class="action-btn view-btn" href="/view-stock/${item._id}"><i class="bi bi-eye"></i></a>
              <a class="action-btn edit-btn" href="/update-stock/${item._id}"><i class="bi bi-pen"></i></a>
