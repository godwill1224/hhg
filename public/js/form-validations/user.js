document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", function (event) {
    ...
    emailInput.style = "border: 1px #087001 solid";
    phoneNumberInput.style = "border: 1px #087001 solid";
    roleSelect.style = "border: 1px #087001 solid";
    branchSelect.style = "border: 1px #087001 solid";
    dateAddedInput.style = "border: 1px #087001 solid";
    profileImageInput.style = "border: 1px #087001 solid";
    passwordInput.style = "border: 1px #087001 solid";
    confirmPasswordInput.style = "border: 1px #087001 solid";
